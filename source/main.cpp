...
int main()
{
    ...
    TH1F hist("wtime", "time", 1000, 400, 800);
    ...
    while (reader.Next())
    {
        ...
        fit->SetParameters(whighavg / (sample12.size() - 800) - wlowavg / 200, wlowavg / 200, 10, 700);
